...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 h2  bg-warning "><a href="/static/home.html">HOME</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/aboutus.html">ABOUT US</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/gallery.html">GALLERY</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/training.html">TRAINING</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/admin.html">ADMIN</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/contact.html">CONTACT US</a></div>
            <img src="./1.png"   style="height:500px;"  alt="1">
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <td class="col-sm-9 h3 bg-primary bg-gradient">Evolution of BPRD</td>
                </tbody>
                <tbody>
                    <tr scope="row">2</tr>
                    <td class=" col-sm-3 h3 bg-primary bg-gradient">2</td>
                    <td class=" col-sm-9 h3 bg-primary bg-gradient">Awards/Medals</td>
                </tbody>
                <tbody>
                    <tr scope="row">3</tr>
                    <td class=" col-sm-3 h3 bg-primary bg-gradient">3</td>
                    <td class=" col-sm-9 h3 bg-primary bg-gradient">Organization</td>
                </tbody>
            <tbody>
                <tr scope="row">4</tr>
                <td class="col-sm-3 h3 bg-primary bg-gradient">4</td>
                <td class="col-sm-9 h3 bg-primary bg-gradient">Work Allocation</td>
            </tbody>
            <tbody>
                <tr scope="row">5</tr>
                <td class=" col-sm-3 h3 bg-primary bg-gradient">5</td>
                <td class=" col-sm-9 h3 bg-primary bg-gradient">Draft Legislation</td>
            </tbody>
            <tbody>
                <tr scope="row">6</tr>
                <td class=" col-sm-3 h3 bg-primary bg-gradient">6</td>
                <td class=" col-sm-9 h3 bg-primary bg-gradient">Citizen Corner</td>
            </tbody>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 bg-white h1 text-center">Bureau of Police Research and Development</div>
            <div class="col-sm-12 bg-white h1 text-center">Ministry of Home affairs</div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/home.html">HOME</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/aboutus.html">ABOUT US</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/gallery.html">GALLERY</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/training.html">TRAINING</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/admin.html">ADMIN</a></div>
            ...
            <div class="h2 bg-primary" style="height:900px;">
                CREATION:</br>
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/admin.html">ADMIN</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/contact.html">CONTACT US</a></div>
            <img src="./1.png"   style="height:300px;"  alt="1">
            <h2 class="text-center bg-danger">Contact Us</h2>
            <div class="h2 bg-primary" style="height:1000px;">
                Address:</br>
